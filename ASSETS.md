...
**Art direction:** High-contrast cyberpunk escape-room interface: deep black foundations, electric cyan and neon pink illumination, restrained violet accents, bold geometric sans-serif typography, controlled outer glow, technical corner brackets, scanline texture, and clear interactive object silhouettes. Room atmospheres should remain distinct while sharing the same HUD language.
